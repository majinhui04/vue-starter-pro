! function (t, e) {
    ...
    var x = {
            drawDataSet: function (t, e, n) {
                ...
                case "Point":
                    ...
                    "circle" === a ? ("Point" === n.bigData && t.moveTo(o[0], o[1]), t.arc(o[0], o[1], r, 0, 2 * Math.PI)) : "rect" === a ? t.rect(o[0] - r / 2, o[1] - r / 2, r, r) : "honeycomb" === a && function (t, e, n, i) {
                        for (var o = 0; o < 6; o++) {
                            var a = (r = {
                                x: e,
                                y: n
                            }, s = i, void 0, h = 60 * o + 30, l = Math.PI / 180 * h, [r.x + s * Math.cos(l), r.y + s * Math.sin(l)]);
                            t.lineTo(a[0], a[1])
                        }
                        var r, s, h, l
                    }(t, o[0], o[1], r);
    ...
    function D(t) {
        t = t || {}, this.gradient = t.gradient || {.25: "rgba(0, 0, 255, 1)", .55: "rgba(0, 255, 0, 1)", .85: "rgba(255, 255, 0, 1)", 1: "rgba(255, 0, 0, 1)"
    ...
    function v(a, t, r) {
        ...
        for (var y in g.forEach(function (t, e) {
            ...
            if (!isNaN(y)) {
                var m = f[y];
                a.beginPath(), r.withoutAlpha || (a.globalAlpha = y), a.strokeStyle = c.getColor(y * s), m.forEach(function (t, e) {
                    if (t.geometry) {
                        var n = t.geometry._coordinates || t.geometry.coordinates,
                            i = t.geometry.type;
                        if ("Point" === i) {
                            var o = void 0 === t.count ? 1 : t.count;
                            a.globalAlpha = o / s, a.drawImage(p, n[0] - v, n[1] - d)
                        } else if ("LineString" === i) {
                            o = void 0 === t.count ? 1 : t.count;
                            a.globalAlpha = o / s, a.beginPath(), x.draw(a, t, r), a.stroke()
                        }
                    }
                })
            }
                    ...
                    if (v(a, r, n), !n.absolute) {
                        ...
                        ! function (t, e, n) {
                            var i = w(n),
                                ...
                                r = 0,
                                s = 1024;
                            (c = n.range || null) && 2 === c.length && (r = (c[0] - o) / a * 1024), c && 2 === c.length && (s = (c[1] - o) / a * 1024);
                            for (var h, l = n.maxOpacity || .8, u = n.minOpacity || 0, c = n.range, p = 3, v = t.length; p < v; p += 4) h = 4 * t[p], t[p] / 256 > l && (t[p] = 256 * l), t[p] / 256 < u && (t[p] = 256 * u), h && r <= h && h <= s ? (t[p - 3] = e[h], t[p - 2] = e[1 + h], t[p - 1] = e[2 + h]) : t[p] = 0
            ...
            draw: function (t, e, n) {
                ...
                if (r) {
                    for (var l = 0; l < i.length; l++) {
                        ...
                        o[d = Math.floor((p[0] - s.x) / a) + "," + Math.floor((p[1] - s.y) / a)] || (o[d] = 0), o[d] += ~~(i[l].count || 1)
                    }
                    for (var u in o) u = u.split(","), t.beginPath(), t.rect(u[0] * a + .5 + s.x, u[1] * a + .5 + s.y, a, a), t.fillStyle = h.getColor(o[u]), t.fill(), n.strokeStyle && n.lineWidth && t.stroke()
                } else {
                    for (var c = 0; c < i.length; c++) {
                        var p;
                        o[d = (p = i[c].geometry._coordinates || i[c].geometry.coordinates).join(",")] = i[c].count || 1
                    }
                    for (var v in o) v = v.split(","), t.beginPath(), t.rect(v[0] - a / 2, v[1] - a / 2, a, a), t.fillStyle = h.getColor(o[v]), t.fill(), n.strokeStyle && n.lineWidth && t.stroke()
                } if (n.label && !1 !== n.label.show)
                    for (var d in t.fillStyle = n.label.fillStyle || "white", n.label.font && (t.font = n.label.font), n.label.shadowColor && (t.shadowColor = n.label.shadowColor), n.label.shadowBlur && (t.shadowBlur = n.label.shadowBlur), o) {
                        var g = o[d = d.split(",")],
            ...
            for (var a = n.offset || {
                ...
                if (1 < 3 * Math.abs(f)) {
                    var y = d - g,
                        ...
                        _ = d - m,
                        w = p - x;
                    _ * _ + w * w < y * y + f * f && (g = m + (1 & v ? 1 : -1) / 2, v = x)
                }
                var b = g + "-" + v,
                    k = l[b];
                k ? k.push(i[u]) : ((k = l[b] = [i[u]]).i = g, k.j = v, k.x = (g + (1 & v ? .5 : 0)) * s, k.y = v * h)
            }
            var E, L, S, C, M = new D({
                max: n.max || 100,
                maxSize: r,
            ...
            for (var o in l) {
                ...
                for (var z = 0; z < 6; z++) {
                    var R = (E = {
                        x: P.x + a.x,
                        y: P.y + a.y
                    }, L = r, void 0, S = 60 * z + 30, C = Math.PI / 180 * S, [E.x + L * Math.cos(C), E.y + L * Math.sin(C)]);
                    t.lineTo(R[0], R[1])
                }
                t.closePath();
                var A = 0;
                for (u = 0; u < P.length; u++) A += P[u].count || 1;
                P.count = A, t.fillStyle = M.getColor(A), t.fill(), n.strokeStyle && n.lineWidth && t.stroke()
            }
            if (n.label && !1 !== n.label.show)
                for (var o in t.fillStyle = n.label.fillStyle || "white", n.label.font && (t.font = n.label.font), n.label.shadowColor && (t.shadowColor = n.label.shadowColor), n.label.shadowBlur && (t.shadowBlur = n.label.shadowBlur), l) {
                    var O = (P = l[o]).count;
                    O = O < 0 ? O.toFixed(2) : ~~O;
            ...
            draw: function (t, e, n) {
                if (e) {
                    ...
                    for (var u = 0, c = e.length; u < c; u++) {
                        ...
                        var m = new Float32Array(v);
                        t.bufferData(t.ARRAY_BUFFER, m, t.STATIC_DRAW), t.drawArrays(t.LINE_STRIP, 0, p.length)
                    }
                }
            }
        },
            ...
            if (e) {
                ...
                for (var s = t.canvas.width / 2, h = t.canvas.height / 2, l = [], u = 0, c = 0; c < e.length; c++) {
                    var p = e[c].geometry._coordinates,
                        v = (p[0] - s) / s,
                        d = (h - p[1]) / h;
                    v < -1 || 1 < v || d < -1 || 1 < d || (l.push(v, d), u++)
                }
                var g = new Float32Array(l),
                    f = u,
                    y = t.createBuffer();
                t.bindBuffer(t.ARRAY_BUFFER, y), t.bufferData(t.ARRAY_BUFFER, g, t.STATIC_DRAW), t.vertexAttribPointer(o, 2, t.FLOAT, !1, 0, 0), t.enableVertexAttribArray(o), t.vertexAttrib1f(a, n._size);
                var m = C(n.fillStyle || "red");
    ...
    function I(t, e, n) {
        n = n || 2;
        var i, o, a, r, s, h, l, u = e && e.length,
            c = u ? e[0] * n : t.length,
            p = F(t, 0, c, n, !0),
            v = [];
        if (!p) return v;
        if (u && (p = function (t, e, n, i) {
            var o, a, r, s, h, l = [];
            for (o = 0, a = e.length; o < a; o++) r = e[o] * i, s = o < a - 1 ? e[o + 1] * i : t.length, (h = F(t, r, s, i, !1)) === h.next && (h.steiner = !0), l.push(V(h));
            for (l.sort(H), o = 0; o < l.length; o++) q(l[o], n), n = B(n, n.next);
            return n
        }(t, e, p, n)), t.length > 80 * n) {
            i = a = t[0], o = r = t[1];
            for (var d = n; d < c; d += n)(s = t[d]) < i && (i = s), (h = t[d + 1]) < o && (o = h), a < s && (a = s), r < h && (r = h);
            l = Math.max(a - i, r - o)
        }
    ...
    function F(t, e, n, i, o) {
        var a, r;
        if (o === 0 < it(t, e, n, i))
            for (a = e; a < n; a += i) r = tt(a, t[a], t[a + 1], r);
        else
            for (a = n - i; e <= a; a -= i) r = tt(a, t[a], t[a + 1], r);
    ...
    function B(t, e) {
        ...
        var n, i = t;
        do {
            if (n = !1, i.steiner || !J(i, i.next) && 0 !== G(i.prev, i, i.next)) i = i.next;
            else {
                if (et(i), (i = e = i.prev) === i.next) return null;
                n = !0
            }
        } while (n || i !== e);
        return e
    ...
    function U(t, e, n, i, o, a, r) {
        if (t) {
            !r && a && function (t, e, n, i) {
                var o = t;
                for (; null === o.z && (o.z = $(o.x, o.y, e, n, i)), o.prevZ = o.prev, o.nextZ = o.next, o = o.next, o !== t;);
                o.prevZ.nextZ = null, o.prevZ = null,
                    function (t) {
                        var e, n, i, o, a, r, s, h, l = 1;
                        do {
                            for (n = t, a = t = null, r = 0; n;) {
                                for (r++, i = n, e = s = 0; e < l && (s++, i = i.nextZ); e++);
                                for (h = l; 0 < s || 0 < h && i;) 0 === s ? (i = (o = i).nextZ, h--) : 0 !== h && i ? n.z <= i.z ? (n = (o = n).nextZ, s--) : (i = (o = i).nextZ, h--) : (n = (o = n).nextZ, s--), a ? a.nextZ = o : t = o, o.prevZ = a, a = o;
                                n = i
                            }
                            a.nextZ = null, l *= 2
                        } while (1 < r)
            ...
            for (var s, h, l = t; t.prev !== t.next;)
                if (s = t.prev, h = t.next, a ? j(t, i, o, a) : Z(t)) e.push(s.i / n), e.push(t.i / n), e.push(h.i / n), et(t), t = h.next, l = h.next;
                else if ((t = h) === l) {
    ...
    function Z(t) {
        ...
        for (var o = t.next.next; o !== t.prev;) {
            if (Y(e.x, e.y, n.x, n.y, i.x, i.y, o.x, o.y) && 0 <= G(o.prev, o, o.next)) return !1;
            o = o.next
        }
        return !0
    }
    ...
    function j(t, e, n, i) {
        ...
        for (var s = o.x < a.x ? o.x < r.x ? o.x : r.x : a.x < r.x ? a.x : r.x, h = o.y < a.y ? o.y < r.y ? o.y : r.y : a.y < r.y ? a.y : r.y, l = o.x > a.x ? o.x > r.x ? o.x : r.x : a.x > r.x ? a.x : r.x, u = o.y > a.y ? o.y > r.y ? o.y : r.y : a.y > r.y ? a.y : r.y, c = $(s, h, e, n, i), p = $(l, u, e, n, i), v = t.nextZ; v && v.z <= p;) {
            if (v !== t.prev && v !== t.next && Y(o.x, o.y, a.x, a.y, r.x, r.y, v.x, v.y) && 0 <= G(v.prev, v, v.next)) return !1;
            v = v.nextZ
        }
    ...
    function N(t, e, n) {
        ...
        do {
            var o = i.prev,
                a = i.next.next;
            !J(o, a) && Q(o, i, i.next, a) && X(o, a) && X(a, o) && (e.push(o.i / n), e.push(i.i / n), e.push(a.i / n), et(i), et(i.next), i = t = a), i = i.next
        } while (i !== t);
        return i
    }
        ...
        do {
            for (var l = h.next.next; l !== h.prev;) {
                if (h.i !== l.i && (s = l, (r = h).next.i !== s.i && r.prev.i !== s.i && ! function (t, e) {
                    var n = t;
                    do {
                        if (n.i !== t.i && n.next.i !== t.i && n.i !== e.i && n.next.i !== e.i && Q(n, n.next, t, e)) return !0;
                        n = n.next
                    } while (n !== t);
                    return !1
                    ...
                    var n = t,
                        ...
                        o = (t.x + e.x) / 2,
                        a = (t.y + e.y) / 2;
                    for (; n.y > a != n.next.y > a && o < (n.next.x - n.x) * (a - n.y) / (n.next.y - n.y) + n.x && (i = !i), n = n.next, n !== t;);
                    return i
                }(r, s))) {
                    var u = K(h, l);
                    return h = B(h, h.next), u = B(u, u.next), U(h, e, n, i, o, a), void U(u, e, n, i, o, a)
                }
                l = l.next
            }
            h = h.next
    ...
    function q(t, e) {
        if (e = function (t, e) {
            ...
            var h, l = n,
                ...
                p = 1 / 0;
            i = n.next;
            for (; i !== l;) o >= i.x && i.x >= u && Y(a < c ? o : r, a, u, c, a < c ? r : o, a, i.x, i.y) && ((h = Math.abs(a - i.y) / (o - i.x)) < p || h === p && i.x > n.x) && X(i, t) && (n = i, p = h), i = i.next;
            return n
        }(t, e)) {
            var n = K(e, t);
            B(n, n.next)
    ...
    var rt = {
            draw: function (t, e, n) {
                if (e) {
                    ...
                    for (var l = [], u = [], c = 0, p = 0, v = e.length; p < v; p++) {
                        ...
                        65536 < (l.length + g.length) / 2 && (t.bufferData(t.ARRAY_BUFFER, new Float32Array(l), t.STATIC_DRAW), t.bufferData(t.ELEMENT_ARRAY_BUFFER, new Uint16Array(u), t.STATIC_DRAW), t.drawElements(t.TRIANGLES, u.length, t.UNSIGNED_SHORT, 0), l.length = 0, c = u.length = 0);
                        for (f = 0; f < g.length; f++) l.push(g[f]);
                        var y = I(g, d.holes, d.dimensions);
        ...
        st = {
            draw: function (t, e, n) {
                var i = e instanceof T ? e.get() : e;
                0 < i.length && ("LineString" == i[0].geometry.type ? m.draw(t, i, n) : "Polygon" == i[0].geometry.type || "MultiPolygon" == i[0].geometry.type ? rt.draw(t, i, n) : O.draw(t, i, n))
            }
        };
    ...
    function ht(t, e, n) {
        ...
        if (void 0 !== e) {
            var g = parseFloat(t.lat),
                ...
                y = parseFloat(t.lng),
                m = parseFloat(e.lng);
            for (y < m && 180 < parseFloat(m - y) && y < 0 && (y = parseFloat(360 + y), m = parseFloat(360 + m)), c = 0, s = f == g ? (r = 0, y - m) : m == y ? (r = Math.PI / 2, g - f) : (r = Math.atan((f - g) / (m - y)), (f - g) / Math.sin(r)), 0 == c && (c = r + Math.PI / 5), u = (h = s / 2) * Math.cos(c) + y, l = h * Math.sin(c) + g, v = 0; v < n + 1; v++) {
                var x = y * i(d) + u * o(d) + m * a(d),
                    _ = g * i(d) + l * o(d) + f * a(d),
                    w = t.lng,
                    b = e.lng;
                p.push([w < 0 && 0 < b ? x - 360 : x, _]), d += 1 / n
            }
            return p
        }
        void 0 !== p && (p = [])
    ...
    ut.prototype.get = function (t) {
        ...
        var n = e || ["rgba(255, 255, 0, 0.8)", "rgba(253, 98, 104, 0.8)", "rgba(255, 146, 149, 0.8)", "rgba(255, 241, 193, 0.8)", "rgba(110, 176, 253, 0.8)", "rgba(52, 139, 251, 0.8)", "rgba(17, 102, 252, 0.8)"],
            i = t.get();
        this.splitList = {};
        for (var o = 0, a = 0; a < i.length && (void 0 === this.splitList[i[a].count] && (this.splitList[i[a].count] = n[o], o++), !(n.length - 1 <= o)); a++);
    ...
    ft && ((dt.prototype = new ft.Overlay).initialize = function (t) {
        ...
        e.style.cssText = "position:absolute;left:0;top:0;z-index:" + this.zIndex + ";user-select:none;", e.style.mixBlendMode = this.mixBlendMode, this.adjustSize();
        ...
        var t = this;
        this.options.updateImmediate ? t._draw() : (clearTimeout(t.timeoutID), t.timeoutID = setTimeout(function () {
            t._draw()
        }, 15))
    ...
    var yt, mt, xt = xt || (yt = [], {
        getAll: function () {
            ...
            var e = yt.indexOf(t); - 1 !== e && yt.splice(e, 1)
        }, update: function (t, e) {
            if (0 === yt.length) return !1;
            var n = 0;
            for (t = void 0 !== t ? t : xt.now(); n < yt.length;) yt[n].update(t) || e ? n++ : yt.splice(n, 1);
            return !0
        }
    });
    "undefined" == typeof window && "undefined" != typeof process ? xt.now = function () {
        ...
        this.to = function (t, e) {
            ...
            for (var e in xt.add(this), E = !(n = !0), x = void 0 !== t ? t : xt.now(), x += m, p) {
                if (p[e] instanceof Array) {
                    if (0 === p[e].length) continue;
                    p[e] = [u[e]].concat(p[e])
                }
            ...
            var e, n, i;
            if (t < x) return !0;
            for (e in !1 === E && (null !== k && k.call(u, u), E = !0), i = _(n = 1 < (n = (t - x) / d) ? 1 : n), p)
                if (void 0 !== c[e]) {
                    var o = c[e] || 0,
                        a = p[e];
                    a instanceof Array ? u[e] = w(a, i) : ("string" == typeof a && (a = "+" === a.charAt(0) || "-" === a.charAt(0) ? o + parseFloat(a) : parseFloat(a)), "number" == typeof a && (u[e] = o + (a - o) * i))
                }
        ...
        Linear: function (t, e) {
            ...
            for (var n = 0, i = t.length - 1, o = Math.pow, a = xt.Interpolation.Utils.Bernstein, r = 0; r <= i; r++) n += o(1 - e, i - r) * o(e, r) * t[r] * a(i, r);
            return n
            ...
            return t[0] === t[n] ? (e < 0 && (o = Math.floor(i = n * (1 + e))), a(t[(o - 1 + n) % n], t[o], t[(o + 1) % n], t[(o + 2) % n], i - o)) : e < 0 ? t[0] - (a(t[0], t[0], t[1], t[1], -i) - t[0]) : 1 < e ? t[n] - (a(t[n], t[n], t[n - 1], t[n - 1], i - n) - t[n]) : a(t[o ? o - 1 : 0], t[o], t[n < o + 1 ? n : o + 1], t[n < o + 2 ? n : o + 2], i - o)
        }, Utils: {
    ...
    var _t = {},
        wt = {
            draw: function (t, e, n) {
                ...
                n.arrow && n.arrow.url && (i = n.arrow.url), _t[i] || (_t[i] = null);
                var o = _t[i];
                if (!o) {
                ...
                for (var l, u, c, p, v, d, g, f = [], y = null, m = 0, x = s.length; m < x; m++) {
                    var _ = s[m];
                    t.save(), (_.fillStyle || _._fillStyle) && (t.fillStyle = _.fillStyle || _._fillStyle), (_.strokeStyle || _._strokeStyle) && (t.strokeStyle = _.strokeStyle || _._strokeStyle);
                    ...
                    if (t.beginPath(), "LineString" === w)
                        for (var b = _.geometry._coordinates || _.geometry.coordinates, k = void 0 !== n.arrow.interval ? n.arrow.interval : 1, E = 0; E < b.length; E += k)
                            if (b[E] && b[E + 1]) {
                                ...
                                t.save();
                                var S = (l = b[E], u = b[E + 1], v = void 0, c = u[0] - l[0], p = u[1] - l[1], v = 360 * Math.atan(p / c) / (2 * Math.PI), u[0] < l[0] && (v += 180), v);
                                t.translate(L[0], L[1]), t.rotate(S * Math.PI / 180), t.drawImage(o, -o.width / 2 / 2, -o.height / 2 / 2, o.width / 2, o.height / 2), t.restore(), f.push(L), y = L
                            }
                    t.restore()
                }
                t.restore()
    ...
    var bt = function (t, e, n) {
            var i = e instanceof T ? e.get() : e;
            t.save(), t.fillStyle = n.fillStyle || "rgba(0, 0, 0, 0.5)", t.fillRect(0, 0, t.canvas.width, t.canvas.height), n.multiPolygonDraw = function () {
                t.save(), t.clip(), k(t), t.restore()
            };
            for (var o = 0, a = i.length; o < a; o++) t.beginPath(), x.drawDataSet(t, [i[o]], n), t.save(), t.clip(), k(t), t.restore();
            t.restore()
        },
        kt = {},
        Et = {},
        Lt = {
            draw: function (t, e, n) {
                ...
                for (var i = e instanceof T ? e.get() : e, o = 0; o < i.length; o++) {
                    ...
                    if (t.beginPath(), a.properties && a.properties.cluster) {
                        if (t.arc(r[0], r[1], a.size, 0, 2 * Math.PI), t.fillStyle = a.fillStyle, t.fill(), n.label && !1 !== n.label.show) {
                            t.fillStyle = n.label.fillStyle || "white", n.label.font && (t.font = n.label.font), n.label.shadowColor && (t.shadowColor = n.label.shadowColor), n.label.shadowBlur && (t.shadowBlur = n.label.shadowBlur);
                ...
                if (h.url) {
                    ...
                    r = r - ~~l / 2 + c.x, s = s - ~~u / 2 + c.y;
                    var p, v, d, g, f, y, m, x, _ = window.encodeURIComponent(h.url),
                        w = kt[_];
                    w ? "error" === w ? i() : l && u ? n.drawImage(w, r, s, l, u) : n.drawImage(w, r, s) : (Et[_] || (Et[_] = [], f = _, y = function (e, t) {
    ...
    var St = function (t, e, n) {
        ...
        if (n.textAlign || (t.textAlign = "center"), n.textBaseline || (t.textBaseline = "middle"), n.avoid)
            for (var h = 0, l = i.length; h < l; h++) {
                ...
                Ct(a, y) || (a.push(y), g += d / 2, f += r / 2, t.fillText(v, g, f))
            } else
                for (h = 0, l = i.length; h < l; h++) {
                    ...
                    u = i[h].offset || n.offset || {
                        x: 0,
                        y: 0
                    }, c = (m = i[h].geometry._coordinates || i[h].geometry.coordinates)[0] + u.x, p = m[1] + u.y, v = i[h][s];
                    t.fillText(v, c, p)
                }
        t.restore()
    };
                ...
                if (o.geometry)
                    if ("string" == typeof (c = o.icon || h.icon)) {
                        var a = window.encodeURIComponent(c),
                            r = Pt[a];
                        r ? At(r, h, s, o) : (zt[a] || (zt[a] = [], t = a, e = function (e, t) {
    ...
    function At(t, e, n, i) {
        ...
        if (a = a - ~~h / 2 + s.x, r = r - ~~l / 2 + s.y, "string" == typeof t) return n.beginPath(), n.arc(a, r, e.size || 5, 0, 2 * Math.PI), n.fillStyle = e.fillStyle || "red", void n.fill();
        var u = i.deg || e.deg;
        u && (n.translate(a, r), n.rotate(u * Math.PI / 180), n.translate(-a, -r)), e.sx && e.sy && e.swidth && e.sheight && e.width && e.height ? n.drawImage(t, e.sx, e.sy, e.swidth, e.sheight, a, r, h, l) : h && l ? n.drawImage(t, a, r, h, l) : n.drawImage(t, a, r), n.restore()
    }
            ...
            ! function t(e, n, i, o, a, r) {
                for (; o < a;) {
                    ...
                    var d = n[2 * i + r],
                        g = o,
                        f = a;
                    for (It(e, n, o, i), n[2 * a + r] > d && It(e, n, o, a); g < f;) {
                        for (It(e, n, g, f), g++, f--; n[2 * g + r] < d;) g++;
                        for (; n[2 * f + r] > d;) f--
                    }
    ...
    function Ut(t, e, n, i, o) {
        void 0 === e && (e = Ft), void 0 === n && (n = Bt), void 0 === i && (i = 64), void 0 === o && (o = Float64Array), this.nodeSize = i;
        for (var a = (this.points = t).length < 65536 ? Uint16Array : Uint32Array, r = this.ids = new a(t.length), s = this.coords = new o(2 * t.length), h = 0; h < t.length; h++) s[2 * (r[h] = h)] = e(t[h]), s[2 * h + 1] = n(t[h]);
        ...
        return function (t, e, n, i, o, a, r) {
            for (var s, h, l = [0, t.length - 1, 0], u = []; l.length;) {
                ...
                if (p - v <= r)
                    ...
                    s = e[2 * g], h = e[2 * g + 1], n <= s && s <= o && i <= h && h <= a && u.push(t[g]);
                    var f = (c + 1) % 2;
                    (0 === c ? n <= s : i <= h) && (l.push(v), l.push(g - 1), l.push(f)), (0 === c ? s <= o : h <= a) && (l.push(g + 1), l.push(p), l.push(f))
                }
            }
            return u
            ...
            return function (t, e, n, i, o, a) {
                for (var r = [0, t.length - 1, 0], s = [], h = o * o; r.length;) {
                    var l = r.pop(),
                        ...
                        c = r.pop();
                    if (u - c <= a)
                        for (var p = c; p <= u; p++) Dt(e[2 * p], e[2 * p + 1], n, i) <= h && s.push(t[p]);
                    else {
                        ...
                        var f = (l + 1) % 2;
                        (0 === l ? n - o <= d : i - o <= g) && (r.push(c), r.push(v - 1), r.push(f)), (0 === l ? d <= n + o : g <= i + o) && (r.push(v + 1), r.push(u), r.push(f))
                    }
                }
                return s
    ...
    function Nt(t) {
        return {
            ...
            geometry: {
                type: "Point",
                coordinates: [360 * (t.x - .5), (e = t.y, n = (180 - 360 * e) * Math.PI / 180, 360 * Math.atan(Math.exp(n)) / Math.PI - 90)]
            }
        };
        var e, n
    }
    ...
    Zt.prototype.load = function (t) {
        ...
        t.length;
        this.points = t;
        for (var a, r, s, h, l, u = [], c = 0; c < t.length; c++) t[c].geometry && u.push((a = t[c], r = c, void 0, s = a.geometry.coordinates, h = s[0], l = s[1], {
            x: Ht(h),
            y: qt(l),
            zoom: 1 / 0,
            index: r,
        ...
        for (var p = i; n <= p; p--) {
            Date.now();
            u = this._cluster(u, p), this.trees[p] = new Ut(u, Vt, Yt, o, Float32Array)
        }
        return this
        ...
        return this._addTileFeatures(i.range((e - s) / o, h, (e + 1 + s) / o, l), i.points, e, n, o, u), 0 === e && this._addTileFeatures(i.range(1 - s / o, h, 1, l), i.points, o, n, o, u), e === o - 1 && this._addTileFeatures(i.range(0, h, s / o, l), i.points, -1, n, o, u), u.features.length ? u : null
        ...
        for (var a = 0, r = this.getChildren(e); a < r.length; a += 1) {
            var s = r[a],
                h = s.properties;
            if (h && h.cluster ? o + h.point_count <= i ? o += h.point_count : o = this._appendLeaves(t, h.cluster_id, n, i, o) : o < i ? o++ : t.push(s), t.length === n) break
        }
        return o
        ...
        for (var r = 0, s = t; r < s.length; r += 1) {
            var h = e[s[r]],
                ...
                c = void 0;
            l ? c = h.id : this.options.generateId ? c = h.index : this.points[h.index].id && (c = this.points[h.index].id), void 0 !== c && (u.id = c), a.features.push(u)
        }
                ...
                if (s <= d) {
                    for (var x = u.x * v, _ = u.y * v, w = r && 1 < v ? this._map(u, !0) : null, b = (l << 5) + (e + 1) + this.points.length, k = 0, E = p; k < E.length; k += 1) {
                        ...
                        if (!(S.zoom <= e)) {
                            S.zoom = e;
                            var C = S.numPoints || 1;
                            x += S.x * C, _ += S.y * C, S.parentId = b, r && r(w = w || this._map(u, !0), this._map(S))
                        }
                    }
                    u.parentId = b, n.push({
                        x: x / d,
        ...
        if (t.numPoints) return e ? $t({}, t.properties) : t.properties;
    ...
    var Gt = (e(Jt, [{
        ...
        value: function () {
            ...
            }), t.category = new ut(t.options.splitList), t.choropleth = new ct(t.options.splitList), void 0 === t.options.splitList && t.category.generateByDataSet(this.dataSet, t.options.color), void 0 === t.options.splitList) {
        ...
        value: function (t, e) {
            var n;
            t = this.canvasLayer.canvas.getContext(this.context), n = "cluster" === this.options.draw && (!this.options.maxClusterZoom || this.options.maxClusterZoom >= this.getZoom()) ? this.clusterDataSet.get() : this.dataSet.get();
    ...
    function Jt(t, e, n) {
        s(this, Jt), e instanceof T || (e = new T(e)), this.dataSet = e, this.map = t, "cluster" !== n.draw || this.supercluster || (this.supercluster = new Zt({
            maxZoom: n.maxZoom || 19,
            radius: n.clusterRadius || 100,
            minPoints: n.minPoints || 2,
            extent: n.extent || 512
        }), this.supercluster.load(e.get()), this.clusterDataSet = new T)
    }
        ...
        ie = (l(oe, Gt), e(oe, [{
            ...
            value: function () {
                ...
                var t = this.map,
                    e = 0,
                    n = this;
                this.options.methods && (this.options.methods.click && (t.setDefaultCursor("default"), t.addEventListener("click", this.clickEvent)), this.options.methods.mousemove && t.addEventListener("mousemove", this.mousemoveEvent), "ontouchend" in window.document && this.options.methods.tap && (t.addEventListener("touchstart", function (t) {
                    e = new Date
            ...
            value: function () {
                var t = this.map;
                this.options.methods && (this.options.methods.click && t.removeEventListener("click", this.clickEvent), this.options.methods.mousemove && t.removeEventListener("mousemove", this.mousemoveEvent))
            }
        }, {
            key: "transferToMercator",
            value: function (t) {
            ...
            value: function (n) {
                if (this.canvasLayer) {
                    ...
                    if (o.isEnabledTime()) {
                    ...
                    } else k(h); if ("2d" == this.context)
                        for (var l in o.options) h[l] = o.options[l];
                    else h.clear(h.COLOR_BUFFER_BIT); if (!(o.options.minZoom && r.getZoom() < o.options.minZoom || o.options.maxZoom && r.getZoom() > o.options.maxZoom)) {
                        var u = 1;
                        ...
                        if (void 0 !== n && (p.filter = function (t) {
                            var e = a.trails || 10;
                            return !!(n && t.time > n - e && t.time < n)
                        }), "cluster" === o.options.draw && (!o.options.maxClusterZoom || o.options.maxClusterZoom >= this.getZoom())) {
                            var v, d, g, f = this.map.getBounds(),
                                y = f.getNorthEast(),
                                m = f.getSouthWest();
                            v = this.supercluster.getClusters([m.lng, m.lat, y.lng, y.lat], this.getZoom());
                            for (var x = 0; x < v.length; x++)(w = v[x]).properties && w.properties.cluster && (void 0 === d && (d = w.properties.point_count), void 0 === g && (g = w.properties.point_count), d = Math.max(d, w.properties.point_count), g = Math.min(g, w.properties.point_count));
                            var _ = new D({
                                min: g,
                                max: d,
                                minSize: o.options.minSize || 8,
                                maxSize: o.options.maxSize || 30,
                                gradient: o.options.gradient
                            });
                            for (x = 0; x < v.length; x++) {
                                var w;
                                (w = v[x]).properties && w.properties.cluster_id ? (v[x].size = _.getSize(w.properties.point_count), v[x].fillStyle = _.getColor(w.properties.point_count)) : v[x].size = o.options.size
                            }
                            this.clusterDataSet.set(v), this.transferToMercator(this.clusterDataSet), c = o.clusterDataSet.get(p)
                        } else c = o.dataSet.get(p);
                        this.processData(c);
                        var b = r.pointToPixel(new ne.Point(0, 0));
                        "m" == o.options.unit ? (o.options.size && (o.options._size = o.options.size / i), o.options.width && (o.options._width = o.options.width / i), o.options.height && (o.options._height = o.options.height / i)) : (o.options._size = o.options.size, o.options._height = o.options.height, o.options._width = o.options.width), this.drawContext(h, c, o.options, b), o.options.updateCallback && o.options.updateCallback(n)
                    }
                }
            }
        }, {
            ...
            value: function (t) {
                var e = this;
                e.options = t, this.initDataRange(t), this.context = e.options.context || "2d", e.options.zIndex && this.canvasLayer && this.canvasLayer.setZIndex(e.options.zIndex), e.options.max && this.intensity.setMax(e.options.max), e.options.min && this.intensity.setMin(e.options.min), this.initAnimator(), this.bindEvent()
            }
        }, {
            key: "getZoom",
            value: function () {
    ...
    function oe(t, e, n) {
        ...
        var i = u(this, (oe.__proto__ || Object.getPrototypeOf(oe)).call(this, t, e, n)),
            o = i;
        n = n || {}, i.clickEvent = i.clickEvent.bind(i), i.mousemoveEvent = i.mousemoveEvent.bind(i), i.tapEvent = i.tapEvent.bind(i), o.init(n), o.argCheck(n), o.transferToMercator();
    ...
    function ae(t) {
        this.isAdded_ = !1, this.isAnimated_ = !1, this.paneName_ = ae.DEFAULT_PANE_NAME_, this.updateHandler_ = null, this.resizeHandler_ = null, this.topLeft_ = null, this.centerListener_ = null, this.resizeListener_ = null, this.needsResize_ = !0, this.requestAnimationFrameId_ = null;
        var e = document.createElement("canvas");
    ...
    re.google && re.google.maps && (ae.prototype = new google.maps.OverlayView, ae.DEFAULT_PANE_NAME_ = "overlayLayer", ae.CSS_TRANSFORM_ = function () {
        ...
        this.canvas.style[ae.CSS_TRANSFORM_] = "translate(" + r + "px," + s + "px)", this.scheduleUpdate()
    ...
    var se = (l(he, Gt), e(he, [{
        ...
        value: function () {
            var t = this.map;
            this.options.methods && (this.options.methods.click && (t.setDefaultCursor("default"), t.addListener("click", this.clickEvent)), this.options.methods.mousemove && t.addListener("mousemove", this.mousemoveEvent))
        }
    }, {
        key: "unbindEvent",
        value: function () {
            var t = this.map;
            this.options.methods && (this.options.methods.click && t.removeListener("click", this.clickEvent), this.options.methods.mousemove && t.removeListener("mousemove", this.mousemoveEvent))
        }
    }, {
        key: "getContext",
        value: function () {
        ...
        value: function (n) {
            if (this.canvasLayer) {
                ...
                if (t.isEnabledTime()) {
                    ...
                    "m" == t.options.unit && t.options.size ? t.options._size = t.options.size / zoomUnit : t.options._size = t.options.size, this.drawContext(e, new T(u), t.options, v), t.options.updateCallback && t.options.updateCallback(n)
                }
            }
        }
    }, {
    ...
    if ("undefined" != typeof maptalks) {
        ue = maptalks.Layer, l(de, ue), e(de, [{
            key: "_initBaseLayer",
            value: function (t) {
        ...
        var pe = (le = maptalks.renderer.CanvasRenderer, l(ve, le), e(ve, [{
            key: "needToRedraw",
            value: function () {
            ...
            value: function (t, n) {
                if (this.canvas) {
                    var e = this.layer.baseLayer,
                        ...
                        o = this.getMap();
                    if (e.isEnabledTime()) {
                        if (void 0 === n) return void k(t);
                        "2d" == e.context && (t.save(), t.globalCompositeOperation = "destination-out", t.fillStyle = "rgba(0, 0, 0, .1)", t.fillRect(0, 0, t.canvas.width, t.canvas.height), t.restore())
                    } else k(t); if ("2d" == e.context)
                    ...
                    e.processData(h), "m" == e.options.unit ? (e.options.size && (e.options._size = e.options.size / zoomUnit), e.options.width && (e.options._width = e.options.width / zoomUnit), e.options.height && (e.options._height = e.options.height / zoomUnit)) : (e.options._size = e.options.size, e.options._height = e.options.height, e.options._width = e.options.width);
                    var l = new maptalks.Point(0, 0),
                        u = o._pointToContainerPoint(l)._multi(1);
                    e.drawContext(t, h, e.options, u), e.options.updateCallback && e.options.updateCallback(n)
                }
            }
        }, {
            key: "createCanvas",
            ...
            value: function () {
                var t = this.layer.baseLayer,
                    e = this.getMap();
                this.devicePixelRatio = e.getDevicePixelRatio ? e.getDevicePixelRatio() : maptalks.Browser.retina ? 2 : 1, t.canvasLayer = this, t._canvasUpdate = this._canvasUpdate.bind(this), t.getContext = function () {
    ...
    var ge = ce,
        fe = (l(ye, Gt), e(ye, [{
            ...
            value: function (t) {
                var e = t.pixel;
                h(ye.prototype.__proto__ || Object.getPrototypeOf(ye.prototype), "clickEvent", this).call(this, e, t)
            }
        }, {
            key: "mousemoveEvent",
            value: function (t) {
                var e = t.pixel;
                h(ye.prototype.__proto__ || Object.getPrototypeOf(ye.prototype), "mousemoveEvent", this).call(this, e, t)
            }
        }, {
            key: "addAnimatorEvent",
            value: function () {
    ...
    function ye() {
        var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null,
            ...
            n = arguments[2];
        s(this, ye);
        var i = u(this, (ye.__proto__ || Object.getPrototypeOf(ye)).call(this, t, e, n));
    ...
    var me = (l(xe, Gt), e(xe, [{
        ...
        value: function (t, n) {
            ...
            if (this.isEnabledTime()) {
                if (void 0 === n) return k(i), this;
                "2d" === this.context && (i.save(), i.globalCompositeOperation = "destination-out", i.fillStyle = "rgba(0, 0, 0, .1)", i.fillRect(0, 0, i.canvas.width, i.canvas.height), i.restore())
            } else k(i); if ("2d" === this.context)
            ...
            return this.processData(l), "m" === this.options.unit ? (this.options.size && (this.options._size = this.options.size / zoomUnit), this.options.width && (this.options._width = this.options.width / zoomUnit), this.options.height && (this.options._height = this.options.height / zoomUnit)) : (this.options._size = this.options.size, this.options._height = this.options.height, this.options._width = this.options.width), this.drawContext(i, new T(l), this.options, {
                x: 0,
                y: 0
            }), this.options.updateCallback && this.options.updateCallback(n), this
        }
    ...
    var _e, we = (l(be, Gt), e(be, [{
        ...
        value: function (t) {
            var e = t || {},
                n = e.data;
            n && n.get && (n = n.get()), null != n && this.dataSet.set(n), h(be.prototype.__proto__ || Object.getPrototypeOf(be.prototype), "update", this).call(this, {
                options: e.options
            })
        }
    }, {
        ...
        value: function (n) {
            if (this.canvasLayer) {
                ...
                } else this.clear(t); if ("2d" === this.context)
    ...
    function be(t, e, n, i) {
        ...
        if (!Gt) return u(o);
        var a = o;
        return i = i || {}, a.init(i), a.argCheck(i), o.canvasLayer = e, o.clickEvent = o.clickEvent.bind(o), o.mousemoveEvent = o.mousemoveEvent.bind(o), o._moveStartEvent = o.moveStartEvent.bind(o), o._moveEndEvent = o.moveEndEvent.bind(o), o._zoomStartEvent = o.zoomStartEvent.bind(o), o.bindEvent(), o
    }
    if ("undefined" != typeof L) {
        var ke = L.Layer.extend({
            ...
            initialize: function (t, e, n) {
                ...
                var i = t.getSize();
                n.style.width = i.x + "px", n.style.height = i.y + "px", this.renderer = new we(t, this, this.dataSet, this.mapVOptions), this.draw(), this.fire("loaded")
            }, onRemove: function () {
    ...
    var Ee, Le = _e,
        Se = (l(Ce, Gt), e(Ce, [{
            ...
            value: function (t) {
                var e = t.point;
                h(Ce.prototype.__proto__ || Object.getPrototypeOf(Ce.prototype), "clickEvent", this).call(this, e, t)
            }
        }, {
            key: "mousemoveEvent",
            value: function (t) {
            ...
            value: function (n) {
                ...
                if (this.canvasLayer && !this.stopAniamation) {
                    ...
                    this.processData(r), "m" == this.options.unit && this.options.size, this.options._size = this.options.size;
                    var s = Cesium.SceneTransforms.wgs84ToWindowCoordinates(i, Cesium.Cartesian3.fromDegrees(0, 0));
                    this.drawContext(t, new T(r), this.options, s), this.options.updateCallback && this.options.updateCallback(n)
                }
            }
        }, {
            key: "updateData",
            value: function (t, e) {
                var n = t;
                n && n.get && (n = n.get()), null != n && this.dataSet.set(n), h(Ce.prototype.__proto__ || Object.getPrototypeOf(Ce.prototype), "update", this).call(this, {
                    options: e
                })
            }
        }, {
    ...
    function Ce(t, e, n, i) {
        s(this, Ce);
        var o = u(this, (Ce.__proto__ || Object.getPrototypeOf(Ce)).call(this, t, e, n));
        return Gt ? (o.map = t, o.scene = t.scene, o.dataSet = e, n = n || {}, o.init(n), o.argCheck(n), o.initDevicePixelRatio(), o.canvasLayer = i, o.stopAniamation = !1, o.animation = n.animation, o.clickEvent = o.clickEvent.bind(o), o.mousemoveEvent = o.mousemoveEvent.bind(o), o.bindEvent(), o) : u(o)
    }
    ...
    function ze(t, e, n, i) {
        if (s(this, ze), this.map = t, this.scene = t.scene, this.mapvBaseLayer = new Se(t, e, n, this), this.mapVOptions = n, this.initDevicePixelRatio(), this.canvas = this._createCanvas(), this.render = this.render.bind(this), i) this.container = i;
        else {
    ...
    t.version = "2.0.59", t.canvasClear = k, t.canvasResolutionScale = function (t) {
    ...
    }, t.canvasDrawSimple = c, t.canvasDrawHeatmap = d, t.canvasDrawGrid = g, t.canvasDrawHoneycomb = f, t.webglDrawSimple = st, t.webglDrawPoint = O, t.webglDrawLine = m, t.webglDrawPolygon = rt, t.utilCityCenter = i, t.utilCurve = lt, t.utilForceEdgeBundling = function () {
        var d = {},
            y = [],
            l = [],
            m = [],
        ...
        function E(t, e, n) {
            for (var i, o, a, r, s, h, l, u, c = x / (_(y[t]) * (e + 1)), p = [{
                x: 0,
                y: 0
            }], v = 1; v < e + 1; v++) {
                var d = {
                    ...
                    g = (o = v, a = c, u = l = void 0, r = m[i = t][o - 1], s = m[i][o + 1], h = m[i][o], l = r.x - h.x + s.x - h.x, u = r.y - h.y + s.y - h.y, {
                        x: l *= a,
                        y: u *= a
                    }),
                    f = k(t, v);
                d.x = n * (g.x + f.x), d.y = n * (g.y + f.y), p.push(d)
            }
            return p.push({
                x: 0,
                y: 0
                    ...
                    for (var a = 1; a < m[e].length; a++) {
                        for (var r = b(m[e][a], m[e][a - 1]); i < r;) {
                            var s = i / r,
                                h = m[e][a - 1].x,
                                l = m[e][a - 1].y;
                            h += s * (m[e][a].x - m[e][a - 1].x), l += s * (m[e][a].y - m[e][a - 1].y), o.push({
                                x: h,
                                y: l
                            }), r -= i, i = n
                        }
        ...
        function C(t, e) {
            ...
            return u = t, c = e, Math.abs((p = f(u), v = f(c), (p.x * v.x + p.y * v.y) / (_(u) * _(c)))) * (h = e, 2 / ((l = (_(s = t) + _(h)) / 2) / Math.min(_(s), _(h)) + Math.max(_(s), _(h)) / l)) * (a = e, (r = (_(o = t) + _(a)) / 2) / (r + b({
            ...
            function () {
                ...
                function () {
                    for (var t = 0; t < y.length - 1; t++)
                        for (var e = t + 1; e < y.length; e++) t != e && (n = y[t], i = y[e], C(n, i) >= g && (l[t].push(e), l[e].push(t)));
                    var n, i
                }();
            for (var i = 0; i < c; i++) {
                for (var o = 0; o < e; o++) {
                    for (var a = [], r = 0; r < y.length; r++) a[r] = E(r, n, t);
                    for (var s = 0; s < y.length; s++)
                        for (var h = 0; h < n + 1; h++) m[s][h].x += a[s][h].x, m[s][h].y += a[s][h].y
                }
                t /= 2, e *= v, L(n *= 2)
            }
            return m
        ...
        return n.nodes = function (t) {
            ...
            return 0 == arguments.length ? y : (y = function (t) {
                for (var e = [], n = 0; n < t.length; n++) d[t[n].source].x != d[t[n].target].x && d[t[n].source].y != d[t[n].target].y && e.push(t[n]);
                return e
            }(t), n)
    ...
    }, t.utilDataRangeIntensity = D, t.utilDataRangeCategory = ut, t.utilDataRangeChoropleth = ct, t.Map = pt, t.baiduMapCanvasLayer = dt, t.baiduMapAnimationLayer = Kt, t.baiduMapLayer = ie, t.googleMapCanvasLayer = ae, t.googleMapLayer = se, t.MaptalksLayer = ge, t.AMapLayer = fe, t.OpenlayersLayer = me, t.leafletMapLayer = Le, t.cesiumMapLayer = Re, t.DataSet = T, t.geojson = Ae, t.csv = Oe, Object.defineProperty(t, "__esModule", {
        value: !0
    })
});