        ...
        <el-card>
            ...
            <div class="sg-table-wrapper">
                <el-table class="sg-table dm-flexbox-1" v-loading="listLoading" :data="dataSource" border fit
                        ...
                        style="width: 100%;" @selection-change="handleSelectionChange" :height="tableHeight" ref="table" :span-method="colspanMethod">
...
<script>
    ...
    import { handleTableSpan, handleObjectSpanMethod } from '../../src/utils/span-method';
    ...
    export default {
        ...
        methods: {
            resize() {
                ...
                let height = null;
                if (this.tools) {
                    height = H - wrapHeight - Number(this.pageSpaceHeight) - Number(this.paginationHeight) - Number(this.toolsHeight);
                } else {
                    height = H - wrapHeight - Number(this.pageSpaceHeight) -Number(this.paginationHeight);
                }
            ...
            fetchList({ page }) {
                ...
                this.config.load && this.config.load(params).then(res => {
                    ...
                    this.total = result.total;
                     this.rowspanObj = handleTableSpan(this.mergekeys, this.dataSource, this.mergekeys[0]);
            ...
            colspanMethod(tableObj){
                 if(this.mergekeys){
                      return handleObjectSpanMethod(tableObj, this.mergekeys, this.rowspanObj, false);
                 }
            }
        }
    };
